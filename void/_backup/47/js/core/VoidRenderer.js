...
export class VoidRenderer {
    ...
    updateParams(newParams) {
        ...
        this.moduleDrawer.setCloseEnds(this.params.closeEnds || false);
    ...
    drawLetter(char, x, y, lineIndex = null, charIndex = null) {
        ...
        for (let i = 0; i < letterCols; i++) {
            for (let j = 0; j < this.rows; j++) {
                ...
                if (shouldUseRounded) {
                    // В dash mode: скругление для всех модулей, укорачивание только для концевых
                    // В solid/stripes: скругление и укорачивание только для концевых
                    this.moduleDrawer.roundedCaps = (this.params.mode === 'dash') ? true : hasEndpoints;

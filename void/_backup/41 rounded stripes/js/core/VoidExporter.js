...
`;
    ...
    renderStraightSVGStrokeStripes(x, y, w, h, stem, strokesNum, strokeGapRatio, roundedCaps = false, localEndpoints = null) {
        ...
        const shortenTop = roundedCaps && localEndpoints && localEndpoints.top ? strokeWidth / 2 : 0;
        const shortenBottom = roundedCaps && localEndpoints && localEndpoints.bottom ? strokeWidth / 2 : 0;

    ...
    drawStraight(ctx, x, y, w, h, angle, stem) {
        ...
        if (this.renderMethod === 'stroke') {
            ...
            if (this.mode === 'fill') {
                ...
                // Вычисляем пунктир для УКОРОЧЕННОЙ длины (после применения укорачивания)
    ...
    drawLink(ctx, x, y, w, h, angle, stem) {
        ...
        if (this.renderMethod === 'stroke') {
            ...
            if (this.mode === 'fill') {
                ...
                // Вертикальная часть: от укороченного верха до начала горизонтальной части
                const vertLength = h / 2 + horizLineY - shortenTop;
                
                // Горизонтальная часть: от вертикальной линии до укороченного правого края

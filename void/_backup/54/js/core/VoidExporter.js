...
export class VoidExporter {
    ...
    getRandomModuleValues(moduleType, params) {
        ...
        const dashLengthMin = params.randomDashLengthMin || 0.1;
        const dashLengthMax = params.randomDashLengthMax || 0.4;
        const gapLengthMin = params.randomGapLengthMin || 0.1;
        const gapLengthMax = params.randomGapLengthMax || 0.4;

...
export class VoidRenderer {
    ...
    getRandomModuleValues(moduleType) {
        ...
        const dashLengthMin = this.params.randomDashLengthMin !== undefined ? this.params.randomDashLengthMin : 0.1;
        const dashLengthMax = this.params.randomDashLengthMax !== undefined ? this.params.randomDashLengthMax : 0.4;
        const gapLengthMin = this.params.randomGapLengthMin !== undefined ? this.params.randomGapLengthMin : 0.1;
        const gapLengthMax = this.params.randomGapLengthMax !== undefined ? this.params.randomGapLengthMax : 0.4;

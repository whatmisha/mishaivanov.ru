...
class VoidTypeface {
    constructor() {
        ...
        this.settings = {
            values: {
                ...
                randomDashLengthMin: 0.1,
                randomDashLengthMax: 0.4,
                randomGapLengthMin: 0.1,
                randomGapLengthMax: 0.4,
        ...
        if (stemMaxInput) {
            stemMaxInput.addEventListener('blur', () => {
                ...
                if (!isNaN(value)) {
                    ...
                    const clampedValue = Math.max(min, Math.min(5.0, value));
    ...
    initModeToggle() {
        ...
        const sdRadio = document.getElementById('modeSD');
        ...
        const updateMode = () => {
            ...
            else if (sdRadio && sdRadio.checked) mode = 'sd';
        ...
        if (sdRadio) {
            sdRadio.addEventListener('change', () => {
    ...
    initPresets() {
        ...
        if (!defaultPreset) {
            ...
            const needsUpdate = 
                ...
                defaultPreset.randomDashLengthMin !== 0.1 ||
                defaultPreset.randomDashLengthMax !== 0.4 ||
                defaultPreset.randomGapLengthMin !== 0.1 ||
                defaultPreset.randomGapLengthMax !== 0.4 ||
    ...
    updateUIFromSettings() {
        ...
        const modeSD = document.getElementById('modeSD');
        if (modeSD) modeSD.checked = mode === 'sd';

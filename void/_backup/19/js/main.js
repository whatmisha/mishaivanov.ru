...
class VoidTypeface {
    constructor() {
        ...
        if (this.isMobile) {
            ...
            // Установить правильную видимость Corner Radius и Rounded Caps при инициализации
    ...
    /**
     * Инициализация тогла Rounded Caps
     */
    ...
    initModeToggle() {
        ...
        const updateMode = () => {
            ...
            // Обновить видимость Rounded Caps
            this.updateRoundedCapsVisibility();

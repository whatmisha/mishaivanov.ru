...
class VoidTypeface {
    constructor() {
        ...
        this.settings = {
            values: {
                ...
                renderMethod: 'fill' // 'fill' или 'stroke'
            },
    ...
    initRenderMethodToggle() {
        ...
        const updateRenderMethod = () => {
            ...
            console.log(`[Render Method] Switching to: ${method}`);
    ...
    updateUIFromSettings() {
        ...
        const renderMethod = this.settings.get('renderMethod') || 'fill';
    ...
    updateRenderer() {
        ...
        this.renderer.updateParams({
            ...
            renderMethod: this.settings.get('renderMethod') || 'fill',

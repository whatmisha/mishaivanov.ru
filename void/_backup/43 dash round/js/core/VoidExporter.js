...
`;
     ...
     */
    renderModuleToSVG(type, rotation, x, y, w, h, stem, mode, strokesNum, strokeGapRatio, cornerRadius = 0, renderMethod = 'stroke', roundedCaps = false, dashLength = 0.10, gapLength = 0.30, endpointSides = null, closeEnds = false) {
    ...
    renderStraightSVGStrokeStripes(x, y, w, h, stem, strokesNum, strokeGapRatio, roundedCaps = false, localEndpoints = null, closeEnds = false) {
        ...
        if (closeEnds && localEndpoints && strokesNum > 0) {
            ...
            if (localEndpoints.top) {
                ...
                svg += `        <line x1="${firstLineX}" y1="${y}" x2="${lastLineX}" y2="${y}" stroke-width="${strokeWidth}" stroke-linecap="round" fill="none"/>\n`;
            }
    ...
    renderRoundSVGStrokeStripes(x, y, w, h, stem, strokesNum, strokeGapRatio, roundedCaps = false, localEndpoints = null, closeEnds = false) {
        ...
        if (closeEnds && localEndpoints && strokesNum > 0) {
            ...
            if (localEndpoints.right) {
                ...
                svg += `        <line x1="${x1}" y1="${y1}" x2="${x2}" y2="${y2}" stroke-width="${strokeWidth}" stroke-linecap="round" fill="none"/>\n`;
            }
    ...
    renderStraightSVGStrokeDash(x, y, w, h, stem, dashLength, gapLength, roundedCaps = false, localEndpoints = null) {
        ...
        // stroke-dashoffset для сдвига паттерна
        const dashOffset = -shortenTop;
    ...
    renderJointSVGStrokeDash(x, y, w, h, stem, dashLength, gapLength, roundedCaps = false, localEndpoints = null) {
        ...
        const vertDashOffset = -shortenTop;
        ...
        svg += `        <line x1="${horizStartX}" y1="${horizLineY}" x2="${horizEndX}" y2="${horizLineY}" stroke-width="${lineWidth}" stroke-linecap="${lineCap}" stroke-linejoin="${lineJoin}" stroke-dasharray="${horizAdaptive.dashLength} ${horizAdaptive.gapLength}"/>\n`;
        return svg;
    }
    ...
    renderRoundSVGStrokeDash(x, y, w, h, stem, dashLength, gapLength, roundedCaps = false, localEndpoints = null) {
        ...
        // stroke-dashoffset для сдвига паттерна
        const dashOffset = -shortenAmount;

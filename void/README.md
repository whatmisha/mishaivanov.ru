...
3. The share URL (`#p=v1…`) is copied automatically.
4. Anyone who opens that URL sees the preset as a temporary “shared” slot; **Save to library** keeps it permanently, **Discard** returns to defaults.
